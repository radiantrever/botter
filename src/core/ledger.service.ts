...
export class LedgerService {
    ...
    calculateFees(grossAmount: number, platformPercent: number, partnerPercent: number = 0) {
    ...
    async recordTransaction(subscriptionId: number, grossAmount: number, creatorId: number) {
